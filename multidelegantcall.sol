...
contract MultiDelegatecall {
        ...
        returns (bytes[] memory results)
    {
        ...
        for (uint i; i < data.length; i++) {
            // When simple call is used- msg.sender will be the contract account itself coz it's te one who called it
            // When delegatecall is used msg.sender will be the caller address who called the function multielegatecall, not the contractwho called it.
